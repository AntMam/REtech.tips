<template>
<section id="navbar" class="relative w-full px-8 text-gray-700 bg-white body-font">
    <div class="container flex items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
        <NuxtLink to="/" class="relative z-10 flex items-center w-auto text-2xl font-bold leading-none text-black select-none pb-3">REtech.tips</NuxtLink>
        <div class="relative z-10 inline-flex items-center space-x-3 md:ml-5 lg:justify-end">
            <NuxtLink to="/" class="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-gray-600 whitespace-no-wrap bg-white border border-gray-200 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:shadow-none">
                Blog
            </NuxtLink>
            <span class="inline-flex rounded-md shadow-sm">
                <NuxtLink to="/blog/author/Anthony" class="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap bg-blue-600 border border-blue-700 rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Contact
                </NuxtLink>
            </span>
        </div>
